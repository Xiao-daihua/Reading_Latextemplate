...
\usepackage[
  backend=biber,
  style=phys,      % 或 numeric, apa, ieee, authoryear, etc.
  eprint=true      % 显示 arXiv
]{biblatex}
...
\begin{abstract}
  This is a template for research project reading notes. You can
  modify the preamble and add your own sections as needed.
  \cite{collierSolving3dGravity2023}
\end{abstract}

\tableofcontents

Hi this is a template here is a todo note \todoNote{This is a todo}
